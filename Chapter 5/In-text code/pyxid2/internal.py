...
class XidConnection(object):
    def __init__(self, ftd2xx_index, baud_rate):
        ...
        self.__using_st_output = True
        self.__line_state = 0

    def set_using_stim_tracker_output(self, using_st=True):
            self.__using_st_output = using_st
